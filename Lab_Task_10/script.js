...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Mobile dropdown elements - dynamically find all dropdown toggles
  ...
  const industriesChevron = document.getElementById(
  ...
  // Toggle dropdown menus - generic function for all dropdowns
  ...
  dropdownToggles.forEach((toggle) => {
    ...
    const chevronId = toggleId.replace("-toggle", "-chevron");
  ...
  // Legacy dropdown handlers for backward compatibility
